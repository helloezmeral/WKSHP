...
final_gb.load_model(saveInProjectRepo('models/XGB_Income/userID/XGB.pickle.dat'))


#Loading encoding file 
with open(saveInProjectRepo('data/UCI_Income/userID/encoding.json'), 'r') as file:
